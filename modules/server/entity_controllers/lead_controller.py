...
class LeadBoardController(ServerRequests):
    ...
    async def get_leaderboard_by_subject_and_class_number(self, subject: Subjects,
                                                          class_number: int) -> aiohttp.ClientResponse:
    ...
    async def get_leaderboard_by_subject_and_class_number_and_class_letter(self, subject: Subjects,
                                                                           class_number: int, class_letter: str) -> aiohttp.ClientResponse:
    ...
    @ServerRequests.request_log(HTTPMethods.GET)
    async def get_leaderboard_by_class_number(self, class_number: int) -> aiohttp.ClientResponse:
    ...
    @ServerRequests.request_log(HTTPMethods.GET)
    async def get_leaderboard_by_class_number_and_class_letter(self, class_number: int, class_letter: str) -> aiohttp.ClientResponse:
